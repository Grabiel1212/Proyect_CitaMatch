...
<body>
    ...
    <div class="menu-buttons">
        ...
        <button id="btn-rechazados"><a href="notificaciones">Ver solicitudes</a></button>
    ...
    <div class="container">
        ...
        <s:if test="personas.size() == 0">
            <div class="panel no-likes-message">
                <h2>Ups aun no a dado ningun me gusta</h2>
                <p>Vuelve al incio para conoser mas personas </p>
            </div>
        </s:if>
            ...
            <s:iterator value="personas">
                <div class="panel">
                    ...
                    <div class="button-container">
                        ...
                        <s:form action="canselar" method="post">
                            <s:hidden name="idUsuarioAceptado" value="%{iduser}"/>
                            <button type="submit" class="reject-btn">Canselar</button>
                        </s:form>
                    </div>
                </div>
            </s:iterator>
